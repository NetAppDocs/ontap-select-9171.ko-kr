...
summary: Python 코드 샘플을 사용하여 ONTAP Select 클러스터를 생성하거나 삭제할 때는 스크립트에 JSON 파일을 입력으로 제공해야 합니다. 배포 계획에 따라 적절한 JSON 샘플을 복사하고 수정할 수 있습니다. 
---
= ONTAP Select 클러스터를 생성하기 위한 스크립트용 JSON
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Python 코드 샘플을 사용하여 ONTAP Select 클러스터를 생성하거나 삭제할 때는 스크립트에 JSON 파일을 입력으로 제공해야 합니다. 배포 계획에 따라 적절한 JSON 샘플을 복사하고 수정할 수 있습니다.
